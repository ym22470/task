...
const InputMessage = () => {
    ...
    return (
        <form onSubmit={handleSubmit}>
            {/* make sure that the changes can be displayed in the textbox.The state gets updated whenever there is a change made to the textbox */}
            <input type="text" className='text-box'value={message} onChange={(e) => setMessage(e.target.value)} />
